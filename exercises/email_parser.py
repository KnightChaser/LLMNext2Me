...
class EmailSummaryStructure(BaseModel):
    ...
    sender_email: EmailStr = Field(
        ..., title="Sender Email", description="The email sender's email address"
    )
    recipient: str = Field(..., title="Recipient", description="The email recipient")
    recipient_email: EmailStr = Field(
        ..., title="Recipient Email", description="The email recipient's email address"
    )
...
def parse_email(question: str, email_contents: str):
    return chain.invoke({"email_contents": email_contents, "question": question})


# Run the decorated function
response = parse_email(
    "Please summarize the important sections of the given email", email_contents
)

# Print the structured result
pprint(response.model_dump())

# {'body': 'Dear Emily, I hope this email finds you well. I wanted to follow up '
#          'on our recent discussion about the 2024 marketing strategy. To '
#          'ensure we’re aligned before the next quarter, I suggest we schedule '
#          'a meeting to finalize the campaign roadmap. Proposed Agenda: - '
#          'Review of Q1 2024 performance metrics - Adjustments to the campaign '
#          'strategy based on recent insights - Allocation of the remaining Q2 '
#          'budget Proposed Time: Thursday, January 11, 2025, at 2:30 PM Please '
#          'let me know if this time works for you or if there’s a better slot '
#          'in your calendar. I look forward to your feedback and our continued '
#          'collaboration to meet our goals for the year. Best regards, Robert '
#          'Johnson Marketing Manager GlobalTech Solutions Phone: (555) 123-4567 '
#          'Email: robert.johnson@globaltech.com',
#  'recipient': 'Emily Davis',
#  'recipient_email': 'emily.davis@globaltech.com',
#  'sender': 'Robert Johnson',
#  'sender_email': 'robert.johnson@globaltech.com',
#  'subject': 'Follow-Up on Marketing Strategy',
#  'summary': 'Robert Johnson from GlobalTech Solutions is following up on the '
#             '2024 marketing strategy discussion with Emily Davis. He proposes '
#             'a meeting to finalize the campaign roadmap, including reviewing '
#             'Q1 2024 performance metrics, adjusting the campaign strategy, and '
#             'allocating the remaining Q2 budget. The proposed meeting time is '
#             'Thursday, January 11, 2025, at 2:30 PM.'}
#
